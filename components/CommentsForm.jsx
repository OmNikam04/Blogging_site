...
const CommentsForm = ({ slug }) => {
  ...
  // ! we dont need to use this value with state as we simply reading the value and sending it to graph cms
  ...
  return (
    <div className="pd-12 mb-8 rounded-lg bg-white p-8 shadow-lg">
      ...
      <div className="mb-4 grid grid-cols-1 gap-4">
        <div className=''>
          ...
          <label className='text-gray-500 cursor-pointer mx-2' htmlFor='storeData'>Save my e-mail and name for next time I comment</label>
        </div>
      </div>
      {error && (
        <p className="text-xs text-red-500">All Fileds are required.</p>
      )}
      <div className="mt-8">
        <button
          type="button"
