...
const PostCard = ({ post }) => {
  console.log(post)
  return (
    <div className="rouded-lg mb-8 bg-white p-0 pb-12 shadow-lg lg:p-8">
      <div className="relative mb-6 overflow-hidden pb-80 shadow-md">
        <img
          src={post.featuredImage.url}
          alt={post.title}
          className="rouded-t-lg absolute h-80 w-full object-cover rounded object-top shadow-lg lg:rounded-lg"
        />
      </div>
      ...
      <div className="mb-8 block w-full items-center justify-center text-center lg:flex">
        <div className="mb-4 mr-8 flex w-full items-center justify-center lg:mb-0 lg:w-auto">
          <img
            ...
            height="30px"
            width="30px"
            className="rounded-full border-2 border-solid border-sky-500 align-middle"
